...
import { INPUT_HIDDEN, deriveDefaultValues, deriveInputs } from '@speculees/zod2form';

const schema = z.object({
  type: z.literal('USER').readonly().describe(INPUT_HIDDEN),
  id: z.string().min(3).max(20).describe(INPUT_HIDDEN).default('123'),
